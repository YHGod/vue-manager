    ...
    <el-form :model="ruleForm2" :rules="rules2"
      ...
      <el-form-item prop="password">
        ...
        >
          ...
          <!--<template slot="suffix"><span class="password-eye" :class="eyeType" @click="showPassword"></span></template>-->
        </el-input>
      </el-form-item>
...
<script>
  export default {
    ...
    methods: {
      ...
      handleSubmit(event){
        this.$store
          .dispatch('LoginIn', this.ruleForm2)
          .then(res => {
            if (!!res.data.success) {
              this.logining = false;
...
//          if (valid) {
//            this.logining = true;
//            if ((this.ruleForm2.username === 'admin' || this.ruleForm2.username === 'user') &&
//              this.ruleForm2.password === '123456') {
//              this.logining = false;
//              this.$store.commit('SET_NAME', this.ruleForm2.username);
//              sessionStorage.setItem('user', this.ruleForm2.username);
//              if (this.checked) {
//                this.setCookie(this.ruleForm2.username, this.ruleForm2.password, 7)
//                this.$notify.success({
